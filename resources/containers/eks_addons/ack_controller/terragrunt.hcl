...
dependency "role_ack_controller" {
  config_path = "${get_parent_terragrunt_dir("root")}/resources/security/iam/roles/ack_ec2_controller"
  mock_outputs = {
    role_arn = "arn:aws:iam::157039837889:role/segoja7-dev-ack-controller"
  }
  mock_outputs_merge_strategy_with_state = "shallow"
}
